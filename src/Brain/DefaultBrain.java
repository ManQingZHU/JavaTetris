package Brain;// Brain.DefaultBrain.java
...
/**
 Provided code.
 A simple Brain.Brain implementation.
 ...
 brain -- just subclass off Brain.DefaultBrain and override rateBoard().
*/
...
public class DefaultBrain implements Brain {
    /**
     ...
     See the Brain.Brain interface for details.
    */
